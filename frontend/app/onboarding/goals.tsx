...
export default function GoalsScreen() {
  ...
  const next = () => {
    ...
    store.setGoal({ goal_type: goal, target_event: goal === 'target_race' ? store.target_event : defaultEvents[goal] });
    router.push(goal === 'target_race' ? '/onboarding/sports' : '/onboarding/experience');
  };
