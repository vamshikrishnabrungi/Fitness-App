    ...
    *,
    ...
    additional_context = {
        ...
        "runner_baseline": {
            ...
            "recent_race_time_seconds": float(athlete.recent_race_time_seconds) if athlete.recent_race_time_seconds is not None else None,
            ...
            "target_time_seconds": float(goal.target_time_seconds) if goal.target_time_seconds is not None else None,
        },
